	...
	<div class="reservations text-center">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="reservations_content d-flex flex-column align-items-center justify-content-center">
						...
						<div class="res_form_container">
							<form action="#" method="POST" id="res_form" class="res_form">
								<div class="d-flex flex-sm-row flex-column align-items-center justify-content-start">
									<input type="text" id="datepicker" name="date" class="res_input" required="required">
									<input type="text" name="time" class="res_input timepicker" required="required">
									<select name="number_people" class="res_select">
                ...
                <div class="alert">
                  <span class="txt3">
                <p>&#9888; If you want to make a reservation, please <a href="login_form.php">Login</a> or <a href="sign-up_form.php">Sign up</a></p>
              </span>
              </div>
							</form>
						</div>
